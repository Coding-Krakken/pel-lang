...
class IRGenerator:
    ...
    def generate(self, model: Model) -> dict[str, Any]:
        ...
        return {"version": "0.1.0", "model": ir_model, "metadata": metadata}
    ...
    def generate_var_node(self, var: VarDecl) -> dict[str, Any]:
        ...
        node = {
            ...
            "name": var.name,
            "type_annotation": (
                self.generate_type(var.type_annotation) if var.type_annotation else None
            ),
    ...
    def generate_expression(self, expr: Expression) -> dict[str, Any]:
        ...
        if isinstance(expr, Literal):
            ...
            return {"expr_type": "Variable", "variable_name": expr.name}
